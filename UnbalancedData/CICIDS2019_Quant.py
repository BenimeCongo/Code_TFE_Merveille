...
def _rank_and_interpret(rows, task_name):
    ...
    text.append(
        "Sur un dataset IDS généralement déséquilibré, la Macro-F1 (moyenne par classe) et la Balanced Accuracy "
...
def save_report(console_text, results_dict, meta):
    ...
    out_dir = desktop / "RESULTATS_CICIDS2019_QINSPIRE_WORD"
    ...
    if DOCX_OK:
        doc = Document()
        doc.add_heading("CICIDS2019 — Rapport de résultats (QELM / QNN / QSVM, quantique-inspiré)", level=1)
    ...
    with open(out_path, "w", encoding="utf-8") as f:
        f.write("CICIDS2019 — Rapport de résultats (QELM / QNN / QSVM, quantique-inspiré)\n")
