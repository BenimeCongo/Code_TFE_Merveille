...
# =========================================================
# PARAMÈTRES  (ADAPTÉS À CICIDS_2017) — ESSENTIELS INCHANGÉS
# =========================================================
...
# =========================================================
# MÉTRIQUES (avec retours dict pour Word)
# =========================================================
...
# =========================================================
# ENCODAGE QUANTIQUE-INSPIRÉ (Transformer sklearn)
# =========================================================
...
# =========================================================
# RAPPORT (BUREAU) — même dossier fixe
# =========================================================
def get_desktop_dir():
    home = Path.home()
    d1 = home / "Desktop"
...
# =========================================================
# MAIN + génération Word/TXT en FIN
# =========================================================
report_path = None
time_col_used = None
...
try:
    ...
    if LABEL_COL not in df.columns:
        possible = [c for c in df.columns if str(c).lower().strip() == "label"]
        if possible:
