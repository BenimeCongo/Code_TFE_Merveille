# -*- coding: utf-8 -*-
"""
Created on Wed Jan 28 18:49:44 2026
...
def print_binary_rates(y_true, y_pred, title=""):
    ...
    # Robustesse si une seule classe présente
    if cm.size != 4:
...
# =========================================================
#   ÉQUILIBRAGE TRAIN MULTICLASSE À SUPPORT ÉGAL (UNDERSAMPLING ÉTALÉ)
# =========================================================
...
# =========================================================
# RUN MODELS (avec stockage résultats)
# =========================================================
...
def save_report(console_text, results_dict, meta):
    ...
    out_dir = desktop / "RESULTATS_CICIDS2019_CLASSIQUE_WORD"
    out_dir.mkdir(parents=True, exist_ok=True)

    ts = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
    base_name = out_dir / f"CICIDS2019_CLASSIQUE_ELM_NN_SVM_{ts}"
    ...
    if DOCX_OK:
        doc = Document()
        doc.add_heading("CICIDS2019 — Rapport de résultats (ELM / NN / SVM)", level=1)
    ...
    with open(out_path, "w", encoding="utf-8") as f:
        f.write("CICIDS2019 — Rapport de résultats (ELM / NN / SVM)\n")
...
# =========================================================
# MAIN (sans print colonnes + sans message "Pas de Timestamp")
# =========================================================
report_path = None
time_col = None
...
try:
    ...
    # LabelEncoder: fit sur df_sample (ordre stable)
